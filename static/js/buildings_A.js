...
function loadBuildings() {
  ...
  return fetchFromOverpass(opQuery)
    .then((basemapJSON) => {
      ...
      var count = 0;
      for (feature of basemapJSON.features) {
        if (feature.geometry.type == "Polygon") {
          if(feature.geometry.coordinates[0][0][0]>startPos_l.longitude && feature.geometry.coordinates[0][0][0]<endPos_l.longitude && feature.geometry.coordinates[0][0][1]>startPos_l.latitude && feature.geometry.coordinates[0][0][1]<endPos_l.latitude){
          // console.log(feature);
          addBuilding(feature);
          count++;
          }
